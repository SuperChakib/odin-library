...
window.addEventListener('keyup', exitForm);
...
function initLibrary() {
  if (localStorage.length && localStorage.getItem('library') !== '[]') {
    // if stored data named differently, would it work ??
...
function displayLibrary() {
  while (collection.firstChild) collection.removeChild(collection.lastChild);
